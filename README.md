...
Для того, чтобы работать с репозиторием необходимо создать его копию при помощи кнопки <img src="common/pic/fork.png" width=50> в правом верхнем углу главной страницы репозитория. Теперь в вашем профиле находится копия оригинального репозитория, с которой вы будете работать.
