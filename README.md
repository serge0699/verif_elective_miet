...
Для того, чтобы работать с репозиторием необходимо создать его копию при помощи кнопки `Fork` (<img src="common/pic/fork.png" width=60>) в правом верхнем углу главной страницы репозитория. Теперь в вашем профиле находится копия оригинального репозитория, с которой вы будете работать.
...
1. Обновить копию репозитория при помощи кнопки `Sync fork` (<img src="common/pic/sync_fork.png" width=100>) главной страницы репозитория;
